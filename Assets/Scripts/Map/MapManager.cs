...
public class MapManager : MonoBehaviour
{
    ...
    {
        Debug.Log($"[Map] UnloadStage ½ÃÀÛ, hadBase={_hasPlayerBase} cell={_playerBaseCell}");

        //1) Á¦ÀÏ ¸ÕÀú ¡®½ÇÁ¦ º£ÀÌ½º Á¦°Å¡¯ (¿ÀºêÁ§Æ® + Á¡À¯ + ¾Ë¸²)
    ...
    public bool SelectPlayerBase(Vector3Int selectedCell, GameObject basePrefab = null, bool occupyBaseCell = true)
    {
        ...
        foreach (var cell in kings)
        {
            ...
            if (cell == selectedCell)
            {
                if (basePrefab != null)
                {
                    //±âÁ¸ Instantiate¸¸ ÇÏ´ø ÄÚµå ¡æ »ý¼º ·¹ÆÛ·±½º º¸°ü
    ...
    /// <summary>
    /// º£ÀÌ½º ¹èÄ¡ »óÅÂ¸¦ ÃÊ±âÈ­ÇÕ´Ï´Ù. (Á¡À¯ ÇØÁ¦ Æ÷ÇÔ)
    /// </summary>
    ...
    /// <summary>
    /// ÇöÀç ¸Ê¿¡ µî·ÏµÈ ¸ðµç Å¸¿ö¸¦ ÆÄ±«ÇÏ°í Á¡À¯¸¦ ÇØÁ¦ÇÕ´Ï´Ù.
    /// </summary>
