...
public class BuildUI : MonoBehaviour
{
    ...
    void LayoutGrids()
    {
        ...
        void Apply(GridLayoutGroup gl)
        {
            ...
            gl.constraintCount = useCols; //  ÀÏÈ¸¼º/±âº» ¿­ ¼ö ¹Ý¿µ
        ...
        //  ÇöÀç ·¹ÀÌ¾Æ¿ô ±âÁØÀ¸·Î ½ÇÁ¦ ±×¸®µå ¹Ú½º Å©±â °è»ê
        ...
        // ÀÌ¹ø Open¿¡¸¸ Àû¿ëµÇ´Â ÀÏÈ¸¼º ·¹ÀÌ¾Æ¿ô ÃÊ±âÈ­
        _layoutOnce = null;
    }
    ...
    void FillGrids(List<TowerOption> options)
    {
        ...
        // ÀÌ¹ø Open¿¡¼­ Àû¿ëµÉ ·¹ÀÌ¾Æ¿ô ±âÁØ
        var (useCols, useRows) = GetEffectiveLayout();
        int perSide = useCols * useRows;   // 1x1ÀÌ¸é 1, 2x2¸é 4
        ...
        for (int i = 0; i < total; i++)
        {
            ...
            if (i < options.Count)
            {
                ...
                btn.Bind(opt, picked =>
                {
                    // OpenAtCellÀº ÀÌÁ¦ _onPick °æ·Î·Î µé¾î¿Â´Ù(¼¿ Ä¸Ã³ ¶÷´Ù)
            ...
            {
                btn.Bind(default, null); // ºó ½½·Ô(ÇÁ¸®ÆÕ¿¡¼­ ¾ÆÀÌÄÜ/ÅØ½ºÆ® ºñ¿öµÎ¸é OK)
            }
        }
    }
